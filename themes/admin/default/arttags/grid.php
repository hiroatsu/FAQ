...
<h2><?php echo 'Arttag'; ?> <a class="addnew" href="<?php echo site_url('admin/arttags/add');?>">Add arttag</a></h2>
	...
	<table class="main" width="100%" cellpadding="0" cellspacing="0">	
		...
		<?php  $alt = true; foreach($options as $row): ?>
			<tr<?php if ($alt) echo ' class="second"'; else echo ' class="first"'; $alt = !$alt; ?>>
				...
				<td class="title" nowrap><a href="<?php echo site_url('admin/arttags/edit/'.$row['tag_id']); ?>"><?php echo $row['tag_name']; ?></a></td>
				<td><?php echo $row['tag_description']; ?></td>
				<td width="15%" nowrap>
					<a href="<?php echo site_url('admin/arttags/edit/'.$row['tag_id']); ?>"><img src="<?php echo base_url(); ?>images/page_edit.png" border="0" alt="<?php echo lang('kb_edit'); ?>" title="<?php echo lang('kb_edit'); ?>" /></a>
					&nbsp;
					<a href="<?php echo site_url('admin/arttags/duplicate/'.$row['tag_id']); ?>"><img src="<?php echo base_url(); ?>images/page_copy.png" border="0" alt="<?php echo lang('kb_duplicate'); ?>" title="<?php echo lang('kb_duplicate'); ?>" /></a>
					&nbsp;
					<a href="javascript:void(0);" onclick="deleteSomething('<?php echo site_url('admin/arttags/delete/'.$row['tag_id']); ?>')"><img src="<?php echo base_url(); ?>images/page_delete.png" border="0" alt="<?php echo lang('kb_delete'); ?>" title="<?php echo lang('kb_delete'); ?>" /></a>
				</td>
			</tr>
			<?php endforeach; ?>
	</table>
