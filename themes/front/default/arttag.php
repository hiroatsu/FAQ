...
<?php echo $topsearch; ?>
	...
	<h2 class="catHeading">
		...
		<a rel="nofollow" title="<?php echo $tag->tag_name; ?> RSS Feed" href="<?php echo site_url('rss/category/'.$tag->tag_uri); ?>"><img src="<?php echo base_url(); ?>themes/front/<?php echo $settings['template']; ?>/images/icon-rss.gif" /></a>
	</h2>
	<p class="catDescription"><?php echo $tag->tag_description; ?></p>
<?php endif; ?>
		...
		<tr>
			<td>
				<table width="100%">
					...
					?>
						<td width="33%">
							<div class="folder"><a href="<?php echo site_url("category/".$row->tag_uri."/"); ?>"><?php echo $row->tag_name; ?></a></div>
						</td>
					<?php
						if((($set+1)%$perline) == 0){
	           				echo "</tr>";
